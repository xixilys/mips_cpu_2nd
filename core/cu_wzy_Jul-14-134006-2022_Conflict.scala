...
//        //   ALU MULDIV MEM branch PRIVILEGE
...
//        )))
//    ))
//    val alu_type = MuxLookup(OpD,0.U.U,Seq(
//        OP_ADDI    -> 1.U,
//        OP_ANDI    -> 1.U,
//        OP_ADDIU   -> 1.U,
//        OP_SLTI    -> 1.U,
...
//            FUNC_CLZ  -> 1.U
//    )))
//    val branch_type = MuxLookup(OpD,0.U.U,Seq(
//        OP_BEQ   -> 1.U,
//        OP_BNE   -> 1.U,
//        OP_BGTZ  -> 1.U,
//        OP_BLEZ  -> 1.U,
...
//        OP_SPECIAL -> MuxLookup(FunctD,1.U,Seq( // 在op相同情况下，根据funct来判断是哪一条指令 这个得写特判
//            FUNC_DIV   ->   (ID_DIV).U,
//            FUNC_DIVU  ->   (ID_DIVU).U,
//            FUNC_MULT  ->   (ID_MULT).U,
//            FUNC_MULTU ->   (ID_MULTU).U),
//        OP_SPECIAL2 -> MuxLookup(FunctD,1.U,Seq(
//            FUNC_CLO -> ID_CLO.U,
//            FUNC_CLZ    -> ID_CLZ.U,
//            FUNC_MUL    -> ID_MUL.U,
//            FUNC_MADD   -> ID_MADD.U,
...
//        OP_CACHE  -> 1.U,
//        OP_SPECIAL  -> MuxLookup(FunctD,1.U,Seq(
//            FUNC_BREAK   ->   1.U,
//            FUNC_SYSCALL ->   1.U)),
//        ( OP_PRIVILEGE) -> MuxLookup(coD,1.U,Seq(
